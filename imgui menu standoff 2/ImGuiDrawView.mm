...
//Define active function
    static bool show_s0_active = false;
        ...
        if (renderPassDescriptor != nil)
        {
            ...
            if (MenDeal == true)
            {                
   ImGui::SetNextWindowSize({263.f,154.f});

ImGui::Begin("you name menu");

ImGui::Checkbox("Overlay", &show_s0);

ImGui::Checkbox("ESP", &show_s1);

ImGui::Checkbox("ESP line", &show_s2);

ImGui::Checkbox("ESP hp", &show_s3);
